...
const _excluded = ["children", "className", "action", "role", "component", "selected", "color", "variant"];
...
const ListItemButtonRoot = (0, _styles.styled)('div', {
  ...
  return [(0, _extends2.default)({}, ownerState.selected && {
    ...
    paddingLeft: 'calc(var(--List-item-paddingLeft) + var(--List-item-startActionWidth, var(--internal-startActionWidth, 0px)) - var(--variant-borderWidth))',
    // --internal variable makes it possible to customize the actionWidth from the top List
    paddingRight: 'calc(var(--List-item-paddingRight) + var(--List-item-endActionWidth, var(--internal-endActionWidth, 0px)) - var(--variant-borderWidth))',
    // --internal variable makes it possible to customize the actionWidth from the top List
    ...
    [`& + .${_listItemButtonClasses.default.root}`]: ownerState.row ? {
      marginLeft: 'var(--List-gap)'
    } : {
      marginTop: 'var(--List-gap)'
    },
    [`& + .${_listItemClasses.default.root}`]: ownerState.row ? {
      marginLeft: 'var(--List-gap)'
    } : {
      marginTop: 'var(--List-gap)'
    }
...
= {
   ...
   */
  inset: _propTypes.default.oneOf(['gutter', 'leftGutter', 'startAdornment']),
