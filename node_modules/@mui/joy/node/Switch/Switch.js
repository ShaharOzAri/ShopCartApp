...
const _excluded = ["checked", "className", "component", "componentsProps", "defaultChecked", "disabled", "onBlur", "onChange", "onFocus", "onFocusVisible", "readOnly", "required", "color", "variant", "size", "startDecorator", "endDecorator"];
...
const useUtilityClasses = ownerState => {
  ...
  return (0, _base.unstable_composeClasses)(slots, _switchClasses.getSwitchUtilityClass, {});
};
...
const switchColorVariables = ({
  ...
  return {
    ...
    '--Switch-track-color': ownerState.variant === 'solid' ? '#fff' : (_theme$vars$palette2 = theme.vars.palette[color]) == null ? void 0 : _theme$vars$palette2.plainColor,
    ...
    '--Switch-thumb-color': ownerState.variant === 'solid' ? (_theme$vars$palette5 = theme.vars.palette[color]) == null ? void 0 : _theme$vars$palette5.plainColor : '#fff'
  };
};

const SwitchRoot = (0, _styles.styled)('span', {
  name: 'JoySwitch',
  slot: 'Root',
...
const Switch = /*#__PURE__*/React.forwardRef(function Switch(inProps, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(SwitchRoot, (0, _extends2.default)({
    ref: ref
  }, otherProps, {
    as: component,
    ownerState: ownerState,
    className: (0, _clsx.default)(classes.root, className),
    children: [startDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(SwitchStartDecorator, (0, _extends2.default)({
      "aria-hidden": "true"
    }, componentsProps.startDecorator, {
      ownerState: ownerState,
      className: (0, _clsx.default)(classes.input, (_componentsProps$star = componentsProps.startDecorator) == null ? void 0 : _componentsProps$star.className),
      children: typeof startDecorator === 'function' ? startDecorator(ownerState) : startDecorator
    })), /*#__PURE__*/(0, _jsxRuntime.jsxs)(SwitchTrack, (0, _extends2.default)({}, componentsProps.track, {
      ownerState: ownerState,
      className: (0, _clsx.default)(classes.track, (_componentsProps$trac = componentsProps.track) == null ? void 0 : _componentsProps$trac.className),
      children: [(_componentsProps$trac2 = componentsProps.track) == null ? void 0 : _componentsProps$trac2.children, /*#__PURE__*/(0, _jsxRuntime.jsx)(SwitchThumb, (0, _extends2.default)({}, componentsProps.thumb, {
        ownerState: ownerState,
        className: (0, _clsx.default)(classes.thumb, (_componentsProps$thum = componentsProps.thumb) == null ? void 0 : _componentsProps$thum.className)
      }))]
    })), /*#__PURE__*/(0, _jsxRuntime.jsx)(SwitchAction, (0, _extends2.default)({}, componentsProps.action, {
      ownerState: ownerState,
      ...
      children: /*#__PURE__*/(0, _jsxRuntime.jsx)(SwitchInput, (0, _extends2.default)({}, componentsProps.input, {
        ownerState: ownerState
      }, getInputProps(), {
    ...
    })), endDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(SwitchEndDecorator, (0, _extends2.default)({
      "aria-hidden": "false"
    }, componentsProps.endDecorator, {
      ownerState: ownerState,
      className: (0, _clsx.default)(classes.input, (_componentsProps$endD = componentsProps.endDecorator) == null ? void 0 : _componentsProps$endD.className),
