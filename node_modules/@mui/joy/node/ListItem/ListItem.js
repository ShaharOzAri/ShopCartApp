...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', nested && 'nested', sticky && 'sticky', color && `color${(0, _utils.unstable_capitalize)(color)}`, variant && `variant${(0, _utils.unstable_capitalize)(variant)}`],
...
calc(-1 * var(--List-item-paddingLeft))`,
  ...
  (0, _extends2.default)({
    ...
    [`& + .${_ListItemButton.listItemButtonClasses.root}`]: ownerState.row ? {
      marginLeft: 'var(--List-gap)'
    } : {
      marginTop: 'var(--List-gap)'
    }
...
const ListItem = /*#__PURE__*/React.forwardRef(function ListItem(inProps, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_NestedListContext.default.Provider, {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(ListItemRoot, (0, _extends2.default)({
      ...
      }), children, endAction && /*#__PURE__*/(0, _jsxRuntime.jsx)(ListItemEndAction, {
