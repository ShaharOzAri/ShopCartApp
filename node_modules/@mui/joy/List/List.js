...
const _excluded = ["component", "className", "children", "size", "row"];
...
const ListRoot = styled('ul', {
  ...
  return [ownerState.nested && _extends({}, applySizeVars(ownerState.instanceSize), {
  ...
  }), !ownerState.nested && _extends({}, applySizeVars(ownerState.size), {
    '--List-padding': '0px',
    '--List-radius': '0px',
    ...
    '--List-item-radius': 'max(var(--List-radius) - var(--List-padding), min(var(--List-padding) / 2, var(--List-radius) / 2))',
