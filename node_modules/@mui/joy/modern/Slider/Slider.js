...
import { SliderUnstyled, SliderValueLabelUnstyled, unstable_composeClasses as composeClasses } from '@mui/base';
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', disabled && 'disabled', orientation === 'vertical' && 'vertical', track === 'inverted' && 'trackInverted', track === false && 'trackFalse', color && `color${capitalize(color)}`, size && `size${capitalize(size)}`],
    rail: ['rail'],
    track: ['track'],
    mark: ['mark'],
    markLabel: ['markLabel'],
...
const Slider = /*#__PURE__*/React.forwardRef(function Slider(inProps, ref) {
  ...
  return /*#__PURE__*/_jsx(SliderUnstyled, _extends({}, other, {
    ...
    componentsProps: _extends({}, componentsProps, {
      ...
      markLabel: _extends({}, componentsProps.markLabel, shouldSpreadAdditionalProps(components.ValueLabel) && {
        ownerState
      })
    })
  }));
