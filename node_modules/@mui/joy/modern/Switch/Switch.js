...
const switchColorVariables = ({
  ...
  return {
    ...
    '--Switch-track-color': ownerState.variant === 'solid' ? '#fff' : theme.vars.palette[color]?.plainColor,
    ...
    '--Switch-thumb-color': ownerState.variant === 'solid' ? theme.vars.palette[color]?.plainColor : '#fff'
  };
};
