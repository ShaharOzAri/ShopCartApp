...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', variant && `variant${capitalize(variant)}`, color && `color${capitalize(color)}`, elevation && `elevation${capitalize(elevation)}`]
  };
...
const SheetRoot = styled('div', {
  ...
  return [{
    '--List-item-stickyBackground': variantStyle?.backgroundColor || variantStyle?.background || theme.vars.palette.background.body,
    // for sticky List
...
= {
  ...
  elevation: PropTypes
  /* @typescript-to-proptypes-ignore */
  .oneOfType([PropTypes.oneOf(['lg', 'md', 'sm', 'xl', 'xs']), PropTypes.string]),
